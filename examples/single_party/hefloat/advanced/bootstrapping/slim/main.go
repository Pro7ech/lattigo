...
func main() {
	...
	Mod1Params := hefloat.Mod1ParametersLiteral{
		...
		Mod1Interval:    16,                  // With EphemeralSecretWeight = 32 and 2^{15} slots, ensures < 2^{-138.7} failure probability
	...
	plaintext := hefloat.NewPlaintext(params, S2CParams.LevelQ)
